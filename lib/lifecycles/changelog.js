...
const romainGagnaireConvention = require('@joethefkingfrypan/bk-conventional-changelog')
...
function outputChangelog (args, newVersion) {
  return new Promise((resolve, reject) => {
    ...
    var gitRawCommitsOpts = {
      format: romainGagnaireConvention.commitFormat,
      merges: null
    }

    var changelogStream = conventionalChangelog({
      config: romainGagnaireConvention
